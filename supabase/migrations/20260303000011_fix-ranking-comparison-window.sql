-- ==========================================
-- Fix fenêtre de recherche du snapshot de référence pour get_ranking_comparison
-- Objectif : trouver un snapshot de référence même si le scraper ne tourne pas
-- exactement à la même heure chaque jour, en utilisant une tolérance ±12h
-- autour de (latest_scraped_at - p_hours heures).
-- ==========================================
